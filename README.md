<?xml version="1.0"?>
<t t-name="scs_freight.report_mn_account_invoice_data_margin_new">
...
<div style="width:100%; height:4px; background-color:#f4821f; margin-top:5px; margin-bottom: 2%;"/>
					...
					<table style="width: 100%;">
						<tr>
							...
							<td style="width: 20%;  font-size:15px; text-align:right;"><t t-esc="o.freight_id.name"/>/01</td>
						</tr>
						<tr>
					...
					<p style="margin:0; font-size:15px; text-align: left;"><b>Ачааны мэдээлэл:</b> 
					
					<t t-foreach="o.freight_id.operation_line_ids" t-as="line">
            	...
            	<t t-if="line.cbm!=0">
    					...
    					<t t-if="line.weight!=0">
    							<span t-esc="line.weight"/>
										...
										<p style="margin:0; font-size:15px; text-align: left;"><b>Чингэлэг хэмжээ: <t t-esc="o.freight_id.container_id.name or ''"/></b>
					
					<t t-foreach="o.freight_id.container_id.name" t-as="line">
    ...
    <tr class="border-black" t-foreach="o.invoice_line_ids" t-as="line">
        ...
        <t t-if="line.price_unit == 0">
        	 <td style="padding: 5px; border: 1px solid black;  text-align: right;">  <span t-esc="round(line.price_unit,2)"/></td>
        	<td style="padding: 5px; border: 1px solid black;  text-align: right;"> <span t-field="line.currency_rate"/></td>
        	<td style="padding: 5px; border: 1px solid black;  text-align: right;"> <span t-esc="round(0, 2)" t-options="{&quot;widget&quot;: &quot;float&quot;, &quot;precision&quot;: 2}"/> ₮</td>
        
        </t>
        <t t-if="line.price_unit != 0">
        	<td style="padding: 5px; border: 1px solid black;  text-align: right;">  <span t-esc="round(line.price_unit/line.currency_rate,2)"/></td>
        	<td style="padding: 5px; border: 1px solid black;  text-align: right;"> <span t-field="line.currency_rate"/></td>
        	<td style="padding: 5px; border: 1px solid black;  text-align: right;"> <span t-esc="round(line.quantity * (line.price_unit/line.currency_rate) * line.currency_rate, 2)" t-options="{&quot;widget&quot;: &quot;float&quot;, &quot;precision&quot;: 2}"/> ₮</td>
        </t>
    ...
    <tr class="border-black">
        ...
        <td style="padding: 3px; border: 1px solid black; text-align: right;"> <span t-field="o.amount_total_signed"/></td>
    </tr>
    ...
    <tr class="border-black">
        ...
        <td style="padding:3px; border: 1px solid black; text-align: right; font-weight: bold;"> <span t-field="o.amount_total_signed"/></td>
    </tr>
</table>
                	...
                	<table style="width: 95%; font-size:15px; margin-left:5%; padding-top:1px;">
		        		<tr>
		        			...
		        			<td style="margin-left:5%; font-size:18px;width: 40%;text-align: left;"><span>		</span> /М.Пүрэвсүрэн/</td>
		        		</tr>
		        	</table> 
                </div>
                </t>
